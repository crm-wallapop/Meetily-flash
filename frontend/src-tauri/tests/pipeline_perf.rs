...
const AUDIO_FILE: &str = r"C:\Users\user\Music\meetily-recordings\Meeting 2026-01-01_00-00-00_2026-01-01_00-00\audio.mp4";
const MODELS_DIR: &str = r"C:\Users\user\AppData\Roaming\com.meetily.ai\models";
const DEFAULT_MODEL: &str = "large-v3-turbo-q5_0";
const DEFAULT_LANGUAGE: &str = "es";
const DEFAULT_VAD_REDEMPTION_MS: u32 = 2000;
const RESULTS_DIR: &str = r"C:\Users\user\Music\meetily-recordings\perf-sweep";
