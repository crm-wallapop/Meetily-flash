...
When the auto-detect feature starts a recording, the system SHALL show a recording-started notification that informs the user a recording has begun and gives them a path to cancel it.
...
#### Scenario: Auto-detected recording surfaces a started notification

- **WHEN** the auto-detect feature starts a recording
- **THEN** a system notification is shown informing the user the recording has begun
- **AND** the notification provides a path to cancel the recording
...
When a recording stops (manually or via auto-stop), the system SHALL show a notification confirming the meeting was saved with the meeting title.
...
#### Scenario: Stopped recording surfaces a saved notification

- **WHEN** a recording stops (manually or via auto-stop) and is saved
- **THEN** a system notification is shown confirming the meeting was saved, including the meeting title
